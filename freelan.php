...
//mysqli_select_db($connection, $dbase) or die("Unable to select database");

$result= mysqli_query( $con, "SELECT cate, videofile FROM $table ORDER BY cate desc, videofile desc, id desc " ) 
...
<!--===============================================================================================-->
	...
	<body onload="responsiveVoice.speak('Hey Freelancer. Good to see you here. Now start freelancing.');">
		<div class="page-wrap">
			...
			<!-- Nav -->
				<nav id="nav">
					<ul>
						<li><a href="freelan.php" class="active"><span style="color:white" class="icon fa-home"></span></a></li>
						<li><a href="gallery.php"><span style="color:white" class="icon fa-camera-retro"></span></a></li>
						<li><a href="generic.html"><span style="color:white" class="icon fa-file-text-o"></span></a></li>
						<li><button class="btn btn-primary icon fa-upload" data-toggle="modal" data-target="#myModals"></button></li>
			...
			<!-- Main -->
				<section id="main">
                  ...
                  <a href="logoutf.php?logout" class="hvr-buzz-out" style="color:#fff;">Sign out</a>  
...
$videos_field= $row['videofile'];
$video_show= "$videos_field";
print "<tr>\n"; 

print "\t<td>\n"; 
echo "<div align=center><video width='320' controls><source src='$video_show'>Your browser does
       ...
       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		...
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('https://res.cloudinary.com/h3av7f1l3s/image/upload/v1546109173/bg-02.jpg');">
				...
				<form class="login100-form validate-form" action="ajaxuploadss.php" id="form" enctype="multipart/form-data" method="post">
...
<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn" type="submit" value="Upload">
								UPLOAD
							</button>
						</div>
