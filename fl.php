...
$res=mysqli_query($con, "SELECT * FROM videos");
$userRow=mysqli_fetch_assoc($res);
/*
echo $userRow['cate'];
    echo $userRow['videofile']
*/
...
<script type="text/javascript">
      var js_var = "<?php echo $userRow['videofile'] ?>";
function popmake() {
    
    document.getElementById('myvideo').src=js_var;
}
</script>
...
<!--===============================================================================================-->
			...
			<!-- Nav -->
				<nav id="nav">
					<ul>
						...
						<li><button class="btn btn-primary icon <fa-upload></fa-upload>" data-toggle="modal" data-target="#myModals"></button></li>
 ...
 <div class="container">
  ...
  <video id="myvideo" controls autoplay width="670" height="377">
</video>
